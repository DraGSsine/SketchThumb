  ...
  const features = [
    {
      ...
      description: "EveryThumbnail created is completely unique and tailored to your needs, never recycled or templated.",
      delay: "0.2s"
    },
    {
      icon: <Sparkles className="w-10 h-10 text-brand-purple" />,
      title: "Fast & Creative",
      description: "Get professionalThumbnail options in seconds, not days or weeks. Save time without sacrificing quality.",
      delay: "0.3s"
    },
    {
      icon: <GameBoard className="w-10 h-10 text-brand-purple" />,
      title: "Multiple Iterations",
      description: "Generate unlimited variations until you find the perfectThumbnail that matches your vision.",
      delay: "0.4s"
    },
    {
    ...
    },
    {
      ...
      description: "Download yourThumbnail in multiple formats (PNG, SVG, JPG) perfect for both digital and print use.",
      delay: "0.6s"
    },
    {
      icon: <CircleCheck className="w-10 h-10 text-brand-purple" />,
      title: "Commercial License",
      description: "AllThumbnails come with full commercial usage rights so you can use them for any business purpose.",
      delay: "0.7s"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 opacity-0 animate-fade-in" style={{ animationDelay: "0.1s", animationFillMode: "forwards" }}>
          <h2 className="heading-lg mb-4">
            Why Choose <span className="bg-blue-purple-gradient bg-clip-text text-transparent">scrive</span>
          </h2>
