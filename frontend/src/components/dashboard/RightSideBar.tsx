...
const RightSideBar = ({ onImageClick }: RightSideBarProps) => {
  ...
  const logoMutation = useMutation({
    ...
    onError: (error) => {
      console.error("Error generatingThumbnail:", error);
            ...
            {[1, 2, 3, 4].map((index) => (
              ...
              >
                ...
                <span className="text-[10px] sm:text-xs text-blue-300 text-center">
                  GeneratedThumbnail will appear here
                </span>
              </div>
            ))}
          </div>
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="relative">
            <Textarea
              ...
              placeholder="Describe theThumbnail you want to generate..."
          ...
          >
            {isGenerating ? (
              ...
              <>
                <Sparkles className="w-4 h-4 md:w-5 md:h-5" /> GenerateThumbnails
              </>
            )}
          </Button>
        </div>
