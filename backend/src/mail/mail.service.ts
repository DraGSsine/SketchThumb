...
export class MailService {
  ...
  async sendOtp(email: string, otp: string) {
    const { data, error } = await this.resend.emails.send({
      from: 'noreply@sketchtothumbnail.com',
      to: [email],
          ...
          ">
            ...
            ">
              <h1 style="
                ...
                margin-bottom: 24px;
                color: #1a1a1a;
              ">Sketch to Thumbnail</h1>
              
              <p style="
                font-size: 16px;
                color: #4a4a4a;
                margin-bottom: 32px;
              ">Welcome! Here's your verification code to get started with transforming your sketches into stunning thumbnails:</p>
              ...
              <p style="
                ...
                color: #9ca3af;
              ">
                © ${new Date().getFullYear()} Sketch to Thumbnail. All rights reserved.
              </p>
            </div>
          </body>
        </html>
